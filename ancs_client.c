...
void AppInit(sleep_state last_sleep_state)
{
    ...
    unsigned char buf[3] = {"\r\n"};
    print_drv->uart->uart_write((unsigned char*)devName, StrLen((char*)devName));print_drv->uart->uart_write(buf, 2);
    print_drv->uart->uart_write((unsigned char*)devName, StrLen((char*)devName));print_drv->uart->uart_write(buf, 2);
    print_drv->uart->uart_write((unsigned char*)devName, StrLen((char*)devName));print_drv->uart->uart_write(buf, 2);
    print_drv->uart->uart_write((unsigned char*)devName, StrLen((char*)devName));print_drv->uart->uart_write(buf, 2);
    print_drv->uart->uart_write((unsigned char*)devName, StrLen((char*)devName));print_drv->uart->uart_write(buf, 2);
...
int csr_printf(const char * sFormat, ...)
{
    ...
    r = csr_vprintf(buffer, 0, sFormat, &ParamList);
    va_end(ParamList);
    driver_t *print_drv;
    print_drv = get_driver();
    print_drv->uart->uart_write((unsigned char*)buffer, r);//print_drv->uart->uart_write(buf, 2);
    return r;
}
