...
typedef enum {
	...
	BLE_CHANGE = 18,
    CMD_PAIRING_CODE_INCOMING = 19,
    CMD_USER_INFO_INCOMING = 20,
    CMD_SYNC_DATE_INCOMING = 21,
    CMD_SET_ALARM_CLOCK_INCOMING = 22,
    CMD_SET_DISP_FORMAT_INCOMING = 23,
    CMD_SYNC_DATA_INCOMING = 24,
    CMD_RESPONSE_TO_WATCH_INCOMING = 25,
    CMD_SEND_NOTIFY_INCOMING = 26,
    CMD_SET_TIME_INCOMING = 27,
    CMD_READ_VERSION_INCOMING = 28,
    CMD_SET_CLOCK_POINTER_INCOMING = 29,
    CMD_SET_VIBRATION_INCOMING = 30,
    CMD_SET_FIND_WATCH_INCOMING = 31,
    CMD_SET_ANCS_BOND_REQ_INCOMING = 32,
    CMD_READ_TIME_STEPS_INCOMING = 33,
	REPORT_MAX,
}REPORT_E;
