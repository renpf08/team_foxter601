...
typedef enum {
    KEYS_A_LONG_PRESS_VALUE         = (KEY_A_LONG_PRESS_POS),
    KEYS_B_LONG_PRESS_VALUE         = (KEY_B_LONG_PRESS_POS),
    KEYS_M_LONG_PRESS_VALUE         = (KEY_M_LONG_PRESS_POS),
    KEYS_A_B_LONG_PRESS_VALUE       = (KEY_A_LONG_PRESS_POS|KEY_B_LONG_PRESS_POS),
    KEYS_A_M_LONG_PRESS_VALUE       = (KEY_A_LONG_PRESS_POS|KEY_M_LONG_PRESS_POS),
    KEYS_B_M_LONG_PRESS_VALUE       = (KEY_B_LONG_PRESS_POS|KEY_M_LONG_PRESS_POS),
    KEYS_A_B_M_LONG_PRESS_VALUE     = (KEY_A_LONG_PRESS_POS|KEY_B_LONG_PRESS_POS|KEY_M_LONG_PRESS_POS),
    KEYS_A_SHORT_PRESS_VALUE        = (KEY_A_SHORT_PRESS_POS),
    KEYS_B_SHORT_PRESS_VALUE        = (KEY_B_SHORT_PRESS_POS),
    KEYS_M_SHORT_PRESS_VALUE        = (KEY_M_SHORT_PRESS_POS),
    KEYS_A_B_SHORT_PRESS_VALUE      = (KEY_A_SHORT_PRESS_POS|KEY_B_SHORT_PRESS_POS),
    KEYS_A_M_SHORT_PRESS_VALUE      = (KEY_A_SHORT_PRESS_POS|KEY_M_SHORT_PRESS_POS),
    KEYS_B_M_SHORT_PRESS_VALUE      = (KEY_B_SHORT_PRESS_POS|KEY_M_SHORT_PRESS_POS),
    KEYS_A_B_M_SHORT_PRESS_VALUE    = (KEY_A_SHORT_PRESS_POS|KEY_B_SHORT_PRESS_POS|KEY_M_SHORT_PRESS_POS),
    STATE_MAX                       = 0xFF
}KEY_STATE_E;
...
typedef struct {
    ...
    u8 report_str_len; /* just for test purpose */
}button_report_t;
