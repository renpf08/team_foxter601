...
{
#if 0
	csr_motor_activity_cfg.pos.group = 0;
	csr_motor_activity_cfg.pos.num = 0;

	csr_motor_activity_cfg.com.group = 0;
	csr_motor_activity_cfg.com.num = 0;

	csr_motor_activity_cfg.neg.group = 0;
	csr_motor_activity_cfg.neg.num = 0;
#endif
