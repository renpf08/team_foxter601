...
typedef struct {
	motor_cfg_t cfg;
}csr_motor_date_cfg_t;

static csr_motor_date_cfg_t csr_motor_date_cfg = {
	.cfg = {
		.pos = {
			.group = 0,
			.num = 0,
...
static s16 csr_motor_date_positive_first_half(void *args)
{
	...
	POS_HIGH(csr_motor_date_cfg.cfg.pos.num);
	return 0;
}
...
static s16 csr_motor_date_positive_second_half(void *args)
{
	...
	COM_HIGH(csr_motor_date_cfg.cfg.com.num);
	NEG_HIGH(csr_motor_date_cfg.cfg.neg.num);	
	return 0;
}
...
{
	csr_motor_date_cfg.cfg.pos.group = args->motor_date_cfg.pos.group;
	csr_motor_date_cfg.cfg.pos.num = args->motor_date_cfg.pos.num;

	csr_motor_date_cfg.cfg.com.group = args->motor_date_cfg.com.group;
	csr_motor_date_cfg.cfg.com.num = args->motor_date_cfg.com.num;

	csr_motor_date_cfg.cfg.neg.group = args->motor_date_cfg.neg.group;
	csr_motor_date_cfg.cfg.neg.num = args->motor_date_cfg.neg.num;

	//wait for complete
	PioSetModes(BIT_MASK(csr_motor_date_cfg.cfg.pos.num)| \
				BIT_MASK(csr_motor_date_cfg.cfg.com.num)| \
				BIT_MASK(csr_motor_date_cfg.cfg.neg.num),
				pio_mode_user);
	
	PioSetDir(csr_motor_date_cfg.cfg.pos.num, PIO_DIR_OUTPUT);
	PioSetDir(csr_motor_date_cfg.cfg.com.num, PIO_DIR_OUTPUT);
	PioSetDir(csr_motor_date_cfg.cfg.neg.num, PIO_DIR_OUTPUT);
	
	PioSetPullModes(BIT_MASK(csr_motor_date_cfg.cfg.pos.num)| \
					BIT_MASK(csr_motor_date_cfg.cfg.com.num)| \
					BIT_MASK(csr_motor_date_cfg.cfg.neg.num),
					pio_mode_no_pulls);
...
{
	csr_motor_date_cfg.cfg.pos.group = 0;
	csr_motor_date_cfg.cfg.pos.num = 0;

	csr_motor_date_cfg.cfg.com.group = 0;
	csr_motor_date_cfg.cfg.com.num = 0;

	csr_motor_date_cfg.cfg.neg.group = 0;
	csr_motor_date_cfg.cfg.neg.num = 0;
