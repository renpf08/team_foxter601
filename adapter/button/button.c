...
#define BUTTON_NUM                          3
#define BUTTON_ULTRA_LONG_PRESS_INTERVAL    10 /* unit: second */
#define BUTTON_LONG_PRESS_INTERVAL          2 /* unit: second */
#define BUTTON_SHORT_PRESS_MASK             0x07
#define BUTTON_LONG_PRESS_MASK              0x70
#define BUTTON_ULTRA_LONG_PRESS_MASK        0x80
...
typedef enum {
    ...
    BUTTON_M_ULTRA_LONG_PRESS_VALUE = (0x10<<BUTTON_U),
...
static button_combo_event_t button_combo_event[] = {
    ...
    {KEY_M_ULTRA_LONG_PRESS,BUTTON_M_ULTRA_LONG_PRESS_VALUE},
    {REPORT_MAX,            BUTTON_STATE_MAX},
};

static button_single_event_t button_single_event[] = {
    {KEY_A_UP,      BUTTON_A, BUTTON_UP,    (0x01<<BUTTON_A),   (0x10<<BUTTON_A),   (0x10<<BUTTON_B)},
    {KEY_A_DOWN,    BUTTON_A, BUTTON_DOWN,  (0x01<<BUTTON_A),   (0x10<<BUTTON_A),   (0x10<<BUTTON_B)},
    {KEY_B_UP,      BUTTON_B, BUTTON_UP,    (0x01<<BUTTON_B),   (0x10<<BUTTON_B),   (0x10<<BUTTON_B)},
    {KEY_B_DOWN,    BUTTON_B, BUTTON_DOWN,  (0x01<<BUTTON_B),   (0x10<<BUTTON_B),   (0x10<<BUTTON_B)},
    {KEY_M_UP,      BUTTON_M, BUTTON_UP,    (0x01<<BUTTON_M),   (0x10<<BUTTON_M),   (0x10<<BUTTON_U)},
    {KEY_M_DOWN,    BUTTON_M, BUTTON_DOWN,  (0x01<<BUTTON_M),   (0x10<<BUTTON_M),   (0x10<<BUTTON_U)},
    {0xFF, 0, 0,  0, 0, 0},
};
...
REPORT_E button_combo_event_handler(u8 combo_evt_flag)
{
    ...
    if(combo_evt_flag & BUTTON_ULTRA_LONG_PRESS_MASK) {
        comb_state_value = (combo_evt_flag|(combo_evt_flag<<4))&BUTTON_ULTRA_LONG_PRESS_MASK;
        //comb_state_value = (comb_state_value&BUTTON_ULTRA_LONG_PRESS_MASK); // wrong here!!!
    } else if(combo_evt_flag & BUTTON_LONG_PRESS_MASK) {
        comb_state_value = (combo_evt_flag|(combo_evt_flag<<4))&BUTTON_LONG_PRESS_MASK;
    } else if(combo_evt_flag & BUTTON_SHORT_PRESS_MASK) {
        comb_state_value = (combo_evt_flag|(combo_evt_flag>>4))&BUTTON_SHORT_PRESS_MASK;
    }
...
s16 button_cb_handler(void *args)
{
    ...
    if(button_single_event[i].trigger_event != 0xFF) {
        if(button_single_event[i].single_event == BUTTON_DOWN) {
        	...
        	if(button_interval >= BUTTON_ULTRA_LONG_PRESS_INTERVAL) { /* m btm ultra long press */
                button.combo_event_flag |= button_single_event[i].ultra_long_press_mask;
        	}
        	else if(button_interval >= BUTTON_LONG_PRESS_INTERVAL) { /* long press */
                button.combo_event_flag |= button_single_event[i].long_press_mask;
        	}
        	else { /* hort press */
                button.combo_event_flag |= button_single_event[i].short_press_mask;
